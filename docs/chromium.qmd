...
For more information, refer to [SCALPEL_downstream_analysis](https://raw.githack.com/plasslab/SCALPEL/refs/heads/dev/docs/chromium_downstream.html) for downstream analysis of the SCALPEL output files.
