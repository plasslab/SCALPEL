...
For the purpose of this demonstration, we provide a subset of the original data:  [reduced_GSE104556](). This data contains a subset of the original data for running purpose.
...
For more information, refer to [SCALPEL_downstream_analysis.qmd](SCALPEL_downstream_analysis.qmd) for downstream analysis of the SCALPEL output files.
