...
For the purpose of this demonstration, we provide a subset of the original data:  [reduced_GSE104556](https://zenodo.org/records/17176865/files/reduced_GSE104556.tar.gz?download=1). This data contains a subset of the original data for running purpose.
...
- [reduced_GENCODE.vM21.annotation.gtf](https://zenodo.org/records/17176838/files/reduced_GENCODE.vM21.annotation.gtf.gz?download=1)
